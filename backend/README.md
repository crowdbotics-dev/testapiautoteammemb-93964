...
## Project Structure
    ...
    ├── testapiautoteammemb_93964  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_93964`
...
2. Clone this repo and `cd testapiautoteammemb_93964`
